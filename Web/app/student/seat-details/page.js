...
function StudentPortalContent() {
  ...
  const [centerCodeFromQuery, setCenterCodeFromQuery] = useState("");
  ...
  useEffect(() => {
    ...
    setCenterCodeFromQuery(searchParams.get("centerCode") || "");
    ...
    async function checkStudentSession() {
      ...
      if (sessionError || !data?.session) {
        const query = centerFromQuery
          ...
          : centerCodeFromQuery
            ? `?centerCode=${encodeURIComponent(centerCodeFromQuery)}`
          : centerIdFromQuery
  ...
  }, [centerFromQuery, centerCodeFromQuery, centerIdFromQuery, router]);
  ...
  async function handleSearch(event) {
    ...
    try {
      ...
      const data = await apiGet("/api/student-seat", {
        ...
        centerCode: centerCodeFromQuery,
                ...
                <BackButton
                  fallbackHref={
                    centerFromQuery
                      ...
                      : centerCodeFromQuery
                        ? `/student/login?centerCode=${encodeURIComponent(centerCodeFromQuery)}`
                      : centerIdFromQuery
