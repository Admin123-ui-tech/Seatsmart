  ...
  await client.query(
    `INSERT INTO students
      (
        ...
        school_name, exam_center, exam_center_code, exam_date, exam_shift, dob,
        class_name, college_id, center_id, created_at, updated_at
      )
     VALUES
      ($1, $2, $3, $4, $5, $6, $7, $8, $9::date, $10, $11::date, $12, $13::uuid, $14::uuid, now(), now())
    ...
    [
      item.rollno,
      item.enrollment_number || item.rollno,
      item.name,
      item.room,
      item.seat,
      item.school_name,
      item.exam_center,
      item.exam_center_code || null,
      item.exam_date || null,
      item.exam_shift || null,
      item.dob || null,
      item.class_name,
      item.college_id || null,
      item.center_id || null,
...
async function run() {
  ...
  try {
    ...
    const students = [
      {
        rollno: "NVC2026001",
        enrollment_number: "EN-NVC-001",
        name: "Arjun Reddy",
        room: "A101",
        seat: "01",
        school_name: college1.name,
        exam_center: center1.name,
        exam_center_code: "CEC101",
      ...
      {
        rollno: "SPC2026001",
        enrollment_number: "EN-SPC-001",
        name: "Varun Shetty",
        room: "C101",
        seat: "03",
        school_name: college2.name,
        exam_center: center2.name,
        exam_center_code: "CPC102",
